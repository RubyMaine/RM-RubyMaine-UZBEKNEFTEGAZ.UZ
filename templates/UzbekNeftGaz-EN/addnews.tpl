	<table class="tableform">
		<tr>
			...
			<td><input type="text" id="title" name="title" style="width: 75.2%; margin-right: 6px;" value="{title}" maxlength="150" class="f_input" />&nbsp;<input style="font-size: 11px;" title="Найти похожие новости" onclick="find_relates(); return false;" type="button" value="Найти похожие" /><span id="related_news"></span></td>
		</tr>
	[urltag]
		<tr>
	...
	[/urltag]
		...
		<tr>
			<td colspan="2">
				<b>Вводная часть: <font color="red">*</font></b> (Обязательно)
				[not-wysywyg]
				<div class="bb-editor">
					{bbcode}
					<textarea name="short_story" id="short_story" onfocus="setFieldName(this.name)" class="f_textarea" rows="15" >{short-story}</textarea>
				</div>
				[/not-wysywyg]
				{shortarea}
			</td>
		...
		<tr>
			<td colspan="2">
				...
				<div class="bb-editor">
					{bbcode}
					<textarea name="full_story" id="full_story" onfocus="setFieldName(this.name)" class="f_textarea" rows="20" >{full-story}</textarea>
				</div>
				[/not-wysywyg]
				{fullarea}
			</td>
	...
	<input type="submit" name="nview" onclick="preview()" value="Просмотр">