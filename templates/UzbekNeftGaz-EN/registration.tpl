	...
	[registration]
		<tr>
			...
			<td>
				<input type="text" name="name" id='name' style="width: 79.5%; margin-right: 6px;" class="f_input" /><input style=" font-size: 11px;" title="Проверить доступность логина для регистрации" onclick="CheckLogin(); return false;" type="button" value="Проверить имя" />
		...
		<tr>
			<td class="label">
				Повторите пароль:<font color="red">*</font>
			</td>
			<td><input type="password" name="password2" class="f_input" /></td>
		</tr>
		<tr>
			<td class="label">Ваш E-Mail:<font color="red">*</font></td>
	...
	[validation]
		...
		<tr>
			...
			<td><textarea name="info" rows="8" class="f_textarea"></textarea></td>
		</tr>
		{xfields}
	[/validation]
	</table><br>
