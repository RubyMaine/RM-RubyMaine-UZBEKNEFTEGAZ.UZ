...
<div id="l-container">
	...
	<div class="container">
		<div class="ticker-news-box">
			<span class="breaking-news">«UZBEKNEFTGAZ» JSC</span>
			<ul id="js-news">
				<li><a> &#10150; Attention! Attention! The site is running in test mode! The site is under maintenance, we apologize for the inconvenience! </li>
			</ul>
		</div>
	</div>
	<!--=== Main-RU INFO ===-->
	...
	<div id="header">
		<header class="clearfix fifth-style">
			{include file="modules/menu-en.tpl"}
		</header>
	</div>
	<!--=== Main-RU MENU ===-->
	...
	<section class="heading-news4">
		{include file="modules/slider-en.tpl"}
	</section>
	<!--=== Main-RU Slider ===-->
	...
	<!--=== State Symbols ===-->
		<section class="block-wrapper shadow-white">
			{include file="modules/state-en.tpl"}
		</section>
	<!--=== State Symbols ===-->
	...
	<!--=== Main-RU Corruption 
		<section class="features-today second-style">
			{include file="modules/corruption-en.tpl"}
		</section>
	 Main-RU Corruption ===-->
	...
	<!--=== Main-RU Youth 
		<section class="feature-video">
			{include file="modules/youth-en.tpl"}
		</section>
	 Main-RU Youth ===-->
	...
	<!--=== Main-RU Footer ===-->
		<footer>
			{include file="modules/footer-en.tpl"}
		</footer>
	<!--=== Main-RU Footer ===-->
