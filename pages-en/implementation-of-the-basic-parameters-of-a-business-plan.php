...
<head>
	<title> Implementation of the basic parameters of a business plan | «UZBEKNEFTEGAZ» JSC </title>
	<?php
									...
									<div class="news-post very-large-post">
											<div class="title-post">
												<div class="title-section">
													<h1><span> Implementation of the basic parameters of a business plan </span></h1>
												</div>
											</div>
