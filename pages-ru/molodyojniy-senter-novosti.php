...
<head>
	<title> Молодежный центр Новости | «УЗБЕКНЕФТГАЗ» АО </title>
	<?php
									...
									<div class="news-post very-large-post">
											<div class="title-post">
												<div class="title-section">
													<h1><span> Молодежный центр Новости </span></h1>
												</div>
											</div>
											...
											<div class="post-content">
												...
												<div class="col4 workall worknews">
													<div class="b-img">
														<a href="http://test.ung.uz/pages-ru/news-slider-pages/studenti-inha.php">
															<img style="border-radius: 5px 5px 0px 0px;" src="images/youth/1.jpg" alt="" />
														</a>
													</div>
													<a href="http://test.ung.uz/pages-uz/news-slider-pages/studenti-inha.php">
														<h5 style="margin-top:0px;">	Студенты Университета Инха ...	</h5>
													</a>
													<p></p>
													<br>
												</div>
												...
												<div class="col4 workall worknews">
													<div class="b-img">
														<a href="http://test.ung.uz/pages-ru/news-slider-pages/el-yurt-umidi.php">
															<img style="border-radius: 5px 5px 0px 0px;" src="images/youth/2.jpg" alt="" />
														</a>
													</div>
													<a href="http://test.ung.uz/pages-uz/news-slider-pages/el-yurt-umidi.php">
														<h5 style="margin-top:0px;">	Фонд "Эль-юрт умиди" ...	</h5>
													</a>
													<p></p>
													<br>
												</div>
