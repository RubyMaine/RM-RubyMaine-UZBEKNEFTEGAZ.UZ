...
<head>
	<title> Ташкилий тузилма | «ЎЗБЕКНЕФТГАЗ» АЖ </title>
	<?php
									...
									<div class="news-post very-large-post">
											<div class="title-post">
												<div class="title-section">
													<h1><span> «Ўзбекнефтгаз» АЖ ижройи аппаратининг ташкилий тузилмаси </span></h1>
												</div>
											</div>
											...
											<div class="post-content">
												...
												<a href="../laravel-download-files/struktura.pdf" class="read-more-button"><i class="fa fa-arrow-circle-right"></i> (PDF) ТАШКИЛИЙ ТУЗИЛМАНИ юклаб олиш</a>
