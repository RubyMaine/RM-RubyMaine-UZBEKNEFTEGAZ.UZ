...
<head>
	<title> Соҳага оид меъёрий хужжатлар | «ЎЗБЕКНЕФТГАЗ» АЖ </title>
	<?php
									...
									<div class="news-post very-large-post">
										<div class="title-post">
											<div class="title-section">
												<h1><span> Соҳага оид меъёрий хужжатлар </span></h1>
											</div>
										</div>
													...
													<li>
														<div class="autor-box">
															...
															<div class="autor-content" style="height:286px;">
																...
																<p> «Ўзбекнефтгаз» АЖ: Портловчи атмосферада ишлаш учун жиҳозларнинг хавфсизлиги тўғрисида. </p>
																<a class="read-more-button" style="margin-top: 20px;" href="../laravel-download-files/struktura.pdf" class="read-more-button"><i class="fa fa-arrow-circle-right"></i> Маълумот №-1 (PDF) форматида юклаб олиш</a>
															</div>
														</div>
													</li>
												</ul>
													...
													<li>
														<div class="autor-box">
															...
															<div class="autor-content" style="height:286px;">
																...
																<p> «Ўзбекнефтгаз» АЖ: Портловчи атмосферада ишлаш учун жиҳозларнинг хавфсизлиги тўғрисида. </p>
																<a class="read-more-button" style="margin-top: 20px;" href="../laravel-download-files/struktura.pdf" class="read-more-button"><i class="fa fa-arrow-circle-right"></i> Маълумот №-2 (PDF) форматида юклаб олиш</a>
															</div>
														</div>
													</li>
												</ul>
