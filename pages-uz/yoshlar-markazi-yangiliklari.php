...
<head>
	<title> Ёшлар маркази янгиликлари | «ЎЗБЕКНЕФТГАЗ» АЖ </title>
	<?php
									...
									<div class="news-post very-large-post">
											<div class="title-post">
												<div class="title-section">
													<h1><span> Ёшлар маркази янгиликлари </span></h1>
												</div>
											</div>
											...
											<div class="post-content">
												...
												<div class="col4 workall worknews">
													<div class="b-img">
														<a href="http://test.ung.uz/pages-uz/news-slider-pages/inha-talabari.php">
															<img style="border-radius: 5px 5px 0px 0px;" src="images/youth/1.jpg" alt="" />
														</a>
													</div>
													<a href="http://test.ung.uz/pages-uz/news-slider-pages/inha-talabari.php">
														<h5 style="margin-top:0px;">	 Инҳа университети талабалари ... 	</h5>
													</a>
													<p></p>
													<br>
												</div>
												...
												<div class="col4 workall worknews">
													<div class="b-img">
														<a href="http://test.ung.uz/pages-uz/news-slider-pages/el-yurt-umidi-jamgarmasi.php">
															<img style="border-radius: 5px 5px 0px 0px;" src="images/youth/2.jpg" alt="" />
														</a>
													</div>
													<a href="http://test.ung.uz/pages-uz/news-slider-pages/el-yurt-umidi-jamgarmasi.php">
														<h5 style="margin-top:0px;">	"Эл-юрт умиди" жамгармаси ... 	</h5>
													</a>
													<p></p>
													<br>
												</div>
