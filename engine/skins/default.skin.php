...
/*
=====================================================
 Laravel 7 PRO WEB APP CRUD - by AO UZBEKNEFTEGAZ
-----------------------------------------------------
 Web site links http://www.ung.uz/
-----------------------------------------------------
 Copyright (c) 2020 AO UZBEKNEFTEGAZ
=====================================================
 This Laravel Codes is protected by AO «UZBEKNEFTGAZ»
=====================================================
 File: default.skin.php
-----------------------------------------------------
 User: AdminPanel System!
=====================================================
*/
...
<head>
	<meta charset="utf-8">
	<link rel="shortcut icon" href="engine/skins/images/favicon.ico">
	<title>АО «UZBEKNEFTEGAZ» - {$lang['skin_title']}</title>
...
<div id="loading-layer" class="shadow-depth3"><i class="fa fa-spinner fa-spin"></i></div>
	<div class="navbar navbar-inverse bg-primary-700">
		<div class="navbar-header">
			<a class="navbar-brand" href="?mod=main">АО «UZBEKNEFTEGAZ»</a>
...
$skin_footer = <<<HTML
					<div class="footer text-muted text-size-small">
						<a href="https://www.ung.uz/" target="_blank">АО «UZBEKNEFTEGAZ»</a> {$year} &copy; Все права защищены.
					</div>
				</div>
			</div>
		</div>
...
<!--MAIN area-->
	...
	<div class="panel panel-default" style="margin-top: 170px;">
      ...
      <div class="panel-heading" style="text-align:center;">
        <img src="engine/skins/images/logo.png" style="width: 337px;text-align: center;">
      </div>
      ...
      <div class="panel-body">
		...
		<!--<div class="text-right"><a href="?mod=lostpassword" class="status-info text-right">{$lang['lost_pass']}</a></div>-->
      </div>

    </div>
	<div class="text-muted text-size-small text-center">
		<a href="https://www.ung.uz/" target="_blank">АО «UZBEKNEFTEGAZ»</a> &copy; {$year} <br> Все права защищены.
	</div>
