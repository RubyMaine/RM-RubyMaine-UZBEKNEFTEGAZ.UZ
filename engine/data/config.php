...
'home_title' => 'AO «UZBEKNEFTGAZ»',

'http_home_url' => 'http:/test.ung.uz/',

'description' => 'Демонстрационная страница AO «UZBEKNEFTGAZ» AJ',

'keywords' => '«UZBEKNEFTGAZ» AJ, neftgaz, oil, UZBEKNEFTGAZ, uzneftgaz, uzbekneftegaz',

'short_title' => 'Демонстрационный сайт AO «UZBEKNEFTGAZ»',
...
'offline_reason' => 'Сайт находится на текущей реконструкции, после завершения всех работ сайт будет открыт.<br><br>Приносим вам свои извинения за доставленные неудобства AO «UZBEKNEFTGAZ»',

'admin_path' => 'admin.ung.uz.php',
